...
final class EFaturaSenkronServisi
{
    ...
    private function satir(EntegratorBaglanti $tanim, EntegratorFatura $f, CarbonImmutable $simdi): array
    {
        return [
            ...
            'gonderici_ad_soyad' => $f->gondericiAdSoyad,
            'alici_ad_soyad' => $f->aliciAdSoyad,
            'gonderici_etiketi' => $f->gondericiEtiketi,
            'alici_etiketi' => $f->aliciEtiketi,
            'irsaliye_no' => $f->irsaliyeNo,
            'siparis_no' => $f->siparisNo,
            'siparis_tarihi' => $f->siparisTarihi,
            'gtb_ref_no' => $f->gtbRefNo,
            'gcb_tescil_no' => $f->gcbTescilNo,
            'gcb_tarihi' => $f->gcbTarihi,
            'portal_notu' => $f->portalNotu,
            'teslim_ref' => $f->teslimRef,
            'harici_aktarim' => $f->hariciAktarim,
            'mail_durumu' => $f->mailDurumu,
            'ilk_gorulme' => $simdi,
            'son_gorulme' => $simdi,
            'created_at' => $simdi,
            'updated_at' => $simdi,
