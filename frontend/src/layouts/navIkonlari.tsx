/**
 * Sidebar menü ikonları — heroicons outline path'leri; harici paket bilinçli
 * eklenmedi (CSP self-contained, bundle küçük). Modül ekledikçe genişler.
 */
const YOLLAR: Record<string, string> = {
  anasayfa:
    'm2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25',
  // Satınalma Talebi: alışveriş sepeti
  satinalmaTalepleri:
  ...
  // SQL Bağlantıları: veritabanı silindiri (circle-stack)
  sqlBaglantilari:
  ...
  // Ekran Tasarım Ayarları: ızgara/yerleşim (squares-2x2)
  ekranTasarimi:
...
interface NavIkonProps {
  ad: string
  className?: string
}

export function NavIkon({ ad, className = 'size-5' }: NavIkonProps) {
  const yol = YOLLAR[ad]
  if (!yol) {
    return null
  }
  ...
  return (
    <svg
      ...
      strokeWidth={1.6}
    >
      <path strokeLinecap="round" strokeLinejoin="round" d={yol} />
    </svg>
  )
}
