...
import { VARSAYILAN_ALIM_YERI } from '@/formAlanlari'
import { VARSAYILAN_ILGI_CINSI } from '@/formAlanlari'
import { VARSAYILAN_TESLIMAT_BICIMI } from '@/formAlanlari'
import { VARSAYILAN_BIRIM } from '@/formAlanlari'
...
export const talepSatiriSchema = z.object({
  ...
  duran_varlik_id: z.string(),
  duran_varlik_adi: z.string(),
  // Satırdaki personel: parti yaması ağacından (PARTI_YAMASI_ID)
  ...
  birim_fiyati: z.string(),
  birim_fiyati_para_id: z.string(),
  birim_fiyati_kuru: z.string(),
  teklif_birim_fiyati: z.string(),
  teklif_para_id: z.string(),
  teklif_kuru: z.string(),
  ...
  hakkinda: z.string(),
  kapandi: z.string(),
  butce_tutari: z.string(),
  gerceklesen_maliyet: z.string(),
